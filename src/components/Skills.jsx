      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
          {filteredCategories.map((catGroup, idx) => (
            <div
              key={idx}
              className="glass-card p-6 rounded-2xl border border-dark-border hover:border-slate-600 transition-all duration-200 flex flex-col h-full group"
            >
              {/* Category Header */}
        ...
        {/* Assurance Note */}
        <div className="mt-12 p-4 rounded-2xl bg-dark-card border border-dark-border max-w-2xl mx-auto flex items-center justify-center gap-3 text-center">
