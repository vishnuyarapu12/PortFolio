            ...
            <Reveal key={idx} delay={idx * 110 + 100} duration={750}>
              <div
                className={`glass-card glass-card-hover p-6 sm:p-8 rounded-3xl border ${
                  edu.isPrimary ? 'border-ocean-400/30' : 'border-dark-border/80 bg-dark-surface/60'
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                  ...
                  <div className="lg:col-span-8">
                    <div className="flex items-center gap-3 mb-3">
                      <div className="w-11 h-11 rounded-2xl bg-dark-surface border border-dark-border group-hover:border-ocean-400/40 flex items-center justify-center text-cyan-400 transition-colors">
                  ...
                  {/* Right: Score Card */}
                  <div className="lg:col-span-4 flex flex-col items-center justify-center p-5 rounded-2xl bg-dark-surface border border-dark-border text-center group-hover:border-ocean-400/30 transition-colors">
