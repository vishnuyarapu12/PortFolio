            ...
            <Reveal key={idx} delay={idx * 110 + 100} duration={750}>
              <div className="relative pl-6 sm:pl-10 group">
                ...
                <div className="hidden sm:block absolute -left-32 top-1 text-right w-24">
                  <span className="font-mono text-xs font-bold px-2.5 py-1 rounded-full bg-dark-card border border-dark-border text-slate-300 group-hover:border-ocean-400/40 group-hover:text-cyan-300 transition-colors">
                    {milestone.year}
                  </span>
                </div>

                {/* Node Dot on Timeline Line */}
                <div className="absolute -left-[17px] top-1.5 w-8 h-8 rounded-full bg-dark-bg border border-dark-border group-hover:border-ocean-400/60 flex items-center justify-center transition-all duration-200 shadow-sm">
                ...
                <div className="glass-card glass-card-hover p-6 sm:p-7 rounded-2xl border border-dark-border">
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2 mb-2">
                    ...
                    <span className="text-[11px] font-mono font-medium px-2.5 py-0.5 rounded-full bg-dark-surface border border-ocean-400/30 text-cyan-300">
                      {milestone.badge}
                    </span>
                  </div>
