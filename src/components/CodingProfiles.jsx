  ...
  return (
    <section className="py-20 bg-dark-bg relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Section Header */}
        <Reveal delay={0} className="flex flex-col items-center text-center mb-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {codingProfiles.map((profile, idx) => (
            <Reveal key={idx} delay={idx * 120 + 100} duration={750}>
              <div className="glass-card glass-card-hover p-6 sm:p-8 rounded-2xl border border-dark-border flex flex-col justify-between h-full group">
                <div>
                  
                  {/* Header */}
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-11 h-11 rounded-xl bg-dark-surface border border-dark-border group-hover:border-ocean-400/40 flex items-center justify-center text-slate-300 transition-colors">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="w-full py-3 px-4 rounded-xl bg-dark-surface border border-dark-border hover:border-ocean-400/50 hover:bg-ocean-500/10 text-slate-200 hover:text-white font-mono text-xs font-semibold flex items-center justify-center gap-2 transition-all duration-200 shadow-sm"
                >
