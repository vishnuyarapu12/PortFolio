    ...
    setTimeout(() => {
      ...
      try {
        confetti({
          ...
          spread: 50,
          origin: { y: 0.7 },
          colors: ['#0a7ea9', '#38bdf8', '#22d3ee', '#ffffff']
        });
      } catch (err) {
        // silent fallback
      }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <Reveal delay={100} className="lg:col-span-5 space-y-6">
            ...
            <div className="glass-card p-6 sm:p-8 rounded-2xl border border-dark-border">
              ...
              {/* Email Copy Card */}
              <div className="p-4 rounded-xl bg-dark-surface border border-dark-border mb-3 hover:border-ocean-400/40 transition-colors">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-lg bg-dark-card border border-dark-border hover:border-ocean-400/40 text-slate-300 hover:text-white transition-colors flex-shrink-0"
              ...
              {/* Phone Card */}
              <div className="p-4 rounded-xl bg-dark-surface border border-dark-border mb-6 hover:border-ocean-400/40 transition-colors">
                <span className="text-[10px] font-mono uppercase tracking-wider text-slate-400 block mb-1">
                  Phone / WhatsApp
                </span>
                <div className="flex items-center justify-between gap-2">
            ...
            <div className="glass-card p-6 rounded-2xl border border-dark-border">
              ...
              <div className="grid grid-cols-3 gap-3">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="p-3.5 rounded-xl bg-dark-surface border border-dark-border hover:border-ocean-400/40 text-slate-300 hover:text-white flex flex-col items-center justify-center gap-1.5 transition-colors group"
                >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl bg-dark-surface border border-dark-border text-white placeholder-slate-500 text-sm focus:outline-none focus:border-ocean-400 focus:ring-1 focus:ring-ocean-400 transition-colors"
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-dark-surface border border-dark-border text-white placeholder-slate-500 text-sm focus:outline-none focus:border-ocean-400 focus:ring-1 focus:ring-ocean-400 transition-colors resize-none"
                    />
                  </div>
                  ...
                  <div className="pt-2 text-center">
                    <a
                      ...
                      className="text-[11px] font-mono text-slate-400 hover:text-cyan-300 transition-colors underline"
                    >
