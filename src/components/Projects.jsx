    ...
    <section id="projects" className="py-24 bg-dark-bg relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <Reveal delay={100} className="mb-14">
          <div className="glass-card glass-card-hover rounded-3xl border border-dark-border p-6 sm:p-8 lg:p-10 relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col justify-between">
                <div>
                  ...
                  {/* Tagline */}
                  <p className="text-sm sm:text-base text-cyan-300 font-medium mb-4 font-mono">
                ...
                <div className="flex flex-wrap items-center gap-4 pt-4 border-t border-dark-border">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-ocean-500 to-sky-500 hover:from-ocean-400 hover:to-sky-400 text-white font-bold text-xs uppercase tracking-wide flex items-center gap-2 shadow-btn-primary transition-all duration-200"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl bg-dark-card border border-dark-border text-slate-300 text-xs font-mono font-medium flex items-center gap-2 hover:border-ocean-400/40 hover:text-white transition-colors"
                  >
              ...
              <div className="lg:col-span-5">
                <div className="p-5 sm:p-6 rounded-2xl bg-dark-surface border border-dark-border relative overflow-hidden">
                  ...
                  <div className="p-3.5 rounded-xl bg-dark-bg border border-dark-border font-mono text-[11px] text-slate-300 leading-relaxed space-y-1">
                    <div className="text-cyan-400 font-medium">$ uvicorn app.main:app --port 8000</div>
                  ...
                  <button
                    onClick={() => onSelectProject(featuredProject)}
                    className="w-full mt-4 py-2.5 rounded-xl bg-dark-card border border-dark-border text-slate-300 hover:text-white hover:border-ocean-400/40 text-xs font-mono flex items-center justify-center gap-2 transition-colors"
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {otherProjects.map((project, pIdx) => (
            <Reveal key={project.id} delay={pIdx * 110 + 120} duration={750}>
              <div className="glass-card glass-card-hover rounded-2xl border border-dark-border p-6 flex flex-col justify-between group relative overflow-hidden h-full">
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="p-2.5 rounded-xl bg-dark-card border border-dark-border group-hover:border-ocean-400/30 transition-colors">
                ...
                <div className="pt-4 border-t border-dark-border mt-auto">
                  ...
                  <div className="flex items-center gap-2.5">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 py-2 px-3 rounded-xl bg-dark-card border border-dark-border hover:border-ocean-400/40 text-slate-300 hover:text-white font-mono text-xs flex items-center justify-center gap-1.5 transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-dark-surface border border-dark-border text-slate-400 hover:text-white hover:border-ocean-400/40 transition-colors"
